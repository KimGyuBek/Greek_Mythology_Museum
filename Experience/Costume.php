    ...
    <div id="wrap">
        ...
        <div id="sub_main">
            ...
            <section id="sub_contents">
                <!-- location -->
                <h3>그리스의상 체험<span>HOME>전시안내>그리스의상 체험</span></h3>
                <!-- location end -->
                ...
                <div id="contents">
                    <div id="txt_box_color">
                        <div id="txt_box_color_wrap">
                            <p>
                                ...
                                <strong class="blue">고대 그리스 사람들은 어떤 옷을 입었을까?</strong>
                                <br>
                                그리스 의상을 입고 그리스신화박물관을 관람하는 동안 나도 직접 그리스 신화 속 주인공이 되어볼까요?
                    ...
                    <div class="exhibition_img">
                        <img src="/img/experience/experience_img02.jpeg" alt="창조관 전경">
                    </div>
                    <!-- page content end -->
