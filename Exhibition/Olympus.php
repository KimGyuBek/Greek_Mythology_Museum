            ...
            <section id="sub_contents">
                ...
                <div id="contents">
                    <div id="txt_box_color">
                        <div id="txt_box_color_wrap">
                            <p>
                                ...
                                <br>
                                그들은 그리스에서 가장 높은 올림포스 산에 거처를 정하고 신들의 음식인 ‘암브로시아’와 음료 ‘넥타르’를 마시며
                                <br>

                                영원한 생명을 누리면서 살아가고 있었습니다. 이제 그들을 세계 유명 박물관, 미술관의 명화와 조각들로 만나보는 시간!
                                <br>

                                임성훈 작가의 대형 애니메이션으로 만나보는 그리스신화 속 숨은 아이템 찾기도 놓칠 수 없는 재미!!
                            </p>
                    ...
                    <div class="exhibition_img">
                        <img src="/img/exhibition/exhibition_img02.jpeg" alt="창조관 전경">
                    </div>
                    <!-- page content end -->
